...
SOURCES = \
	__init__.py \
	clasificacion_redes.py clasificacion_redes_dialog.py

PLUGINNAME = clasificacion_redes

PY_FILES = \
	__init__.py \
	clasificacion_redes.py clasificacion_redes_dialog.py

UI_FILES = clasificacion_redes_dialog_base.ui
...
QGISDIR=C:\Users\rcruz\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
